namespace Ssjw.EAutoService.ServicesDataUSvc.RestClient
{
    ...
    public class ServicesDataUSvcClient : IInspectionsDataDto, IRepairsDataDto
    {
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/AddInspection", "localhost", 7021);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/AddRepair", "localhost", 7021);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/FindInspectionById?id={2}", "localhost", 7021, id);
            return SingleInspectionCall(requestUri);
        }

        public RepairDto FindRepairById(string id)
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/FindRepairById?id={2}", "localhost", 7021, id);
            return SingleRepairCall(requestUri);
        }

        public List<InspectionDto> GetAllByPassedFieldInspections(bool passed)
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/GetAllByPassedFieldInspections?passed={2}", "localhost",
                7021, passed);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/GetAllInspections", "localhost", 7021);
            return InspectionListCall(requestUri);
        }

        public List<RepairDto> GetAllRepairs()
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/GetAllRepairs", "localhost", 7021);
            return RepairListCall(requestUri);
        }

        public InspectionDto GetInspectionEmployeeIdVinNumber(string id)
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/GetEmployeeIdVinNumber?id={2}", "localhost",
                7021, id);
            return SingleInspectionCall(requestUri);
        }
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/GetInspectionsByVinNumber?vinNumber={2}", "localhost",
                7021, vinNumber);
            return InspectionListCall(requestUri);
        }
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/GetRepairByVinNumber?vinNumber={2}", "localhost", 7021,
                vinNumber);
            return RepairListCall(requestUri);
        }
        ...
        public List<RepairedPartDto> GetRepairedPartsById(string id)
        {
            ...
            try
            {
                string requestUri = String.Format("https://{0}:{1}/RepairsData/GetRepairedPartsById?id={2}", "localhost", 7021, id);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/InspectionsData/RemoveInspection?id={2}", "localhost", 7021, id);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/RemoveRepair?id={2}", "localhost", 7021, id);
        ...
        {
            string requestUri = String.Format("https://{0}:{1}/RepairsData/GetRepairEmployeeIdVinNumber?id={2}", "localhost", 7021,
                id);
            return SingleRepairCall(requestUri);
        }
